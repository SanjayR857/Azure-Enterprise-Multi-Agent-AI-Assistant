  ...
  const renderSessionItem = (session) => (
    ...
    >
      ...
      <div className="session-actions">
        <button
          className="session-menu-btn session-pin-btn"
          ...
          <div className="sessions-scroll">
            {pinnedSessions.length > 0 && (
              <div className="sessions-section">
                <div className="sessions-label" style={{ marginTop: '0', paddingTop: '0' }}>
                  <span>Pinned</span>
                </div>
            ...
            {recentSessions.length > 0 && (
              <div className="sessions-section" style={{ marginTop: pinnedSessions.length > 0 ? '12px' : '0' }}>
                <div className="sessions-label">
                  <span>Chats</span>
                </div>
